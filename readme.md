...
This library quickly identifies users who have an adblocker installed on their browser or network (i.e. PiHole). It's relatively light (just 615 bytes minified) and uses no external libraries or dependencies.
